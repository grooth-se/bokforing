...
class SIEImporter:
    ...
    def _create_missing_account(self, company_id: int, account_number: str) -> Optional[Account]:
        ...
        bas_names = {
            ...
            '1019': 'Ack avskr balanserade utgifter',
            '1210': 'Byggnader',
            '1219': 'Ack avskr byggnader',
            '1220': 'Inventarier och verktyg',
            '1229': 'Ack avskr inventarier',
            '1230': 'Maskiner',
            '1239': 'Ack avskr maskiner',
            '1250': 'Datorer',
            ...
            '2010': 'Eget kapital',
            '2011': 'Eget kapital, delägare 1',
            '2012': 'Eget kapital, delägare 2',
            '2013': 'Aktiekapital',
            '2019': 'Övrigt bundet eget kapital',
            '2020': 'Eget kapital',
            '2060': 'Eget uttag',
            '2068': 'Vinst eller förlust föregående år',
            '2069': 'Årets resultat',
            '2081': 'Aktiekapital',
            '2082': 'Ej registrerat aktiekapital',
            '2083': 'Erhållna aktieägartillskott',
            '2084': 'Egna aktier',
            '2085': 'Uppskrivningsfond',
            '2086': 'Reservfond',
            '2087': 'Fond för yttre underhåll',
            '2090': 'Fritt eget kapital',
            '2091': 'Balanserad vinst eller förlust',
            '2092': 'Mottagna aktieägartillskott',
            '2093': 'Erhållna koncernbidrag',
            '2094': 'Lämnade koncernbidrag',
            '2095': 'Fusionsresultat',
            '2097': 'Överkursfond',
            '2098': 'Vinst eller förlust föregående år',
            '2099': 'Årets resultat',
            # Skulder (22xx-29xx)
            '2210': 'Avsättningar för pensioner',
            '2220': 'Avsättningar för skatter',
            '2310': 'Banklån',
            '2330': 'Checkräkningskredit',
            '2350': 'Skulder till koncernföretag',
            '2395': 'Skulder till delägare',
            '2399': 'Övriga långfristiga skulder',
            '2410': 'Kortfristiga låneskulder',
            ...
            '2730': 'Lagstadgade sociala avgifter',
            '2731': 'Avräkning lagstadgade sociala avgifter',
            '2732': 'Arbetsgivaravgifter',
            '2790': 'Övriga lönerelaterade skulder',
            '2820': 'Kortfristiga skulder till koncernföretag',
            '2890': 'Övriga kortfristiga skulder',
            '2898': 'Outtagen vinstutdelning',
            '2899': 'Övriga upplupna kostnader',
            '2910': 'Upplupna löner',
            ...
            # Intäkter (3xxx)
            '3000': 'Försäljning',
            '3010': 'Försäljning inom Sverige',
            '3011': 'Försäljning varor 25% moms',
            '3040': 'Försäljning tjänster',
            '3041': 'Försäljning tjänster 25% moms',
            '3100': 'Försäljning EU',
            '3200': 'Försäljning export',
            '3550': 'Fakturerade frakter',
            '3590': 'Övriga sidointäkter',
            '3600': 'Leasing-/hyresintäkter',
            '3740': 'Öres- och kronutjämning',
            '3960': 'Valutakursvinster',
            # Kostnader (4xxx-8xxx)
            '4010': 'Inköp varor',
            '4990': 'Förändring lager',
            '5010': 'Lokalhyra',
            ...
            '7230': 'Löner till styrelse',
            '7290': 'Förändring semesterlöneskuld',
            '7331': 'Skattefria traktamenten',
            '7332': 'Skattepliktiga traktamenten',
            '7385': 'Bilförmån',
            '7510': 'Arbetsgivaravgifter',
            '7519': 'Sociala avgifter för semester',
            '7533': 'Särskild löneskatt pensionskostnader',
            ...
            '7820': 'Avskrivningar inventarier',
            '7830': 'Avskrivningar maskiner',
            '7832': 'Avskrivningar byggnader',
            '7834': 'Avskrivningar datorer',
            '7960': 'Valutakursförluster',
            '8010': 'Koncernbidrag',
            '8310': 'Ränteintäkter',
            '8410': 'Räntekostnader',
            '8423': 'Räntekostnader banklån',
